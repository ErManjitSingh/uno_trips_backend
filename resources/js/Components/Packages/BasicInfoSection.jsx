import CustomRichTextEditor from '../Blog/CustomRichTextEditor'
...
export default function BasicInfoSection({ data, setData, advanced, setAdvancedField, onTitleChange, onSlugChange, onEditorImageUpload }) {
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        ...
        <div className="space-y-1 md:col-span-2">
          <span className="text-xs font-medium text-slate-500">Read More Content</span>
          <CustomRichTextEditor
            value={advanced.full_description}
            onChange={(value) => setAdvancedField('full_description', value)}
