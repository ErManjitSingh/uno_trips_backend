  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        ...
        <label className="space-y-1"><span className="text-xs font-medium text-slate-500">Robots</span><select className={baseInput} value={advanced.robots} onChange={(e) => setAdvancedField('robots', e.target.value)}><option>index,follow</option><option>noindex,nofollow</option></select></label>
