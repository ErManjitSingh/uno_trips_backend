...
export default function AdminLayout({ title, children }) {
    ...
    const [collapsed, setCollapsed] = useState(
        () => localStorage.getItem("admin_sidebar") === "collapsed",
    );
        ...
        >
            <div className="flex h-full">
                <aside
                    ...
                    } relative hidden md:block h-screen shrink-0 overflow-hidden border-r border-amber-200/70 bg-amber-100/60 p-4 shadow-[0_10px_40px_rgba(120,53,15,0.10)] backdrop-blur-xl transition-all duration-200 dark:border-stone-700/80 dark:bg-stone-900`}
                >
                        ...
                        <div className="rounded-2xl border border-amber-200 bg-white p-3 shadow-sm dark:border-stone-700 dark:bg-stone-900">
                            <div className="flex items-start justify-between gap-2">
                                <div className="min-w-0 flex-1">
                                    <div className="grid h-12 w-full place-items-center rounded-xl bg-[#111] ring-1 ring-amber-300 shadow-sm">
                                        <img
                                    ...
                                    {!collapsed && (
                                        <div className="mt-2 min-w-0">
                                            <p className="truncate text-sm font-semibold leading-5 text-stone-900 dark:text-amber-50">
                                                UNO Trips
                                            </p>
                                            <p className="truncate text-xs text-stone-500 dark:text-amber-100/70">
                                                Admin Panel
                                            </p>
                                        </div>
                                    )}
                                ...
                                <button
                                    ...
                                    className="rounded-lg border border-amber-200 p-1.5 text-stone-500 hover:bg-amber-100 dark:border-stone-700 dark:hover:bg-stone-800"
                                    title={
                                        collapsed
                                            ? "Expand sidebar"
                                            : "Collapse sidebar"
